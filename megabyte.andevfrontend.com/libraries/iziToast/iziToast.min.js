          ...
          0 !== a &&
            ...
            a > 0
              ? ((r = (d - a) / d),
                l > r &&
                  e.hide(
                    g(o, { transitionOut: "fadeOutRight", transitionOutMobile: "fadeOutRight" }),
                    t,
                    "drag"
                  ))
              : ((r = (d + a) / d),
                l > r &&
                  e.hide(
                    g(o, { transitionOut: "fadeOutLeft", transitionOutMobile: "fadeOutLeft" }),
                    t,
                    "drag"
                  )),
            (t.style.opacity = r),
      ...
      return {
        start: function () {
          "undefined" == typeof a.time.REMAINING &&
            ...
            null !== r &&
              ((r.style.transition = "width " + a.timeout + "ms " + a.progressBarEasing),
              (r.style.width = "0%")),
            ...
            (a.time.TIMER = setTimeout(function () {
              clearTimeout(a.time.TIMER),
                e.classList.contains(n + "-closing") ||
                  (i.hide(a, e, "timeout"), "function" == typeof o && o.apply(i));
            }, a.timeout)),
      ...
      p.toast.setAttribute("data-iziToast-ref", s.ref),
        ...
        (function () {
          if (
            ...
            o || window.innerWidth <= d
              ? s.transitionInMobile && p.toast.classList.add(s.transitionInMobile)
          ...
          s.image &&
            ...
            h(s.image.replace(/ /g, ""))
              ? (p.cover.style.backgroundImage =
                  "url(data:image/png;base64," + s.image.replace(/ /g, "") + ")")
          ...
          s.title.length > 0 &&
            ...
            s.title.length > 0 &&
              ...
              (s.rtl
                ...
                : 2 === s.layout || s.rtl || (p.strong.style.marginRight = "10px"));
        })(),
      ...
      !(function () {
        ...
        (function () {
          if (s.animateInside) {
            ...
            var t = [200, 100, 300];
            ("bounceInLeft" != s.transitionIn && "bounceInRight" != s.transitionIn) ||
              (t = [400, 200, 400]),
              s.title.length > 0 &&
                setTimeout(function () {
