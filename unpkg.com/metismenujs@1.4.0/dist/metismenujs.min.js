...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).MetisMenu = e());
})(this, function () {
  "use strict";
  const t = { parentTrigger: "li", subMenu: "ul", toggle: !0, triggerElement: "a" },
    e = {
      ACTIVE: "mm-active",
  ...
  class s {
      ...
      0 !== n.length &&
        n.forEach((t) => {
          ...
          "true" !== (null == n ? void 0 : n.getAttribute("aria-disabled")) &&
            (null == n || n.setAttribute("aria-expanded", "false"),
    ...
    emit(t, e, s = !1) {
      const i = new CustomEvent(t, { bubbles: s, detail: e });
    ...
    show(t) {
      ...
      const a = () => {
          i.classList.remove(r),
            ...
            this.emit("shown.metisMenu", { shownElement: i });
        },
      ...
      const g = [].slice
        .call(
          null === (s = null == h ? void 0 : h.parentNode) || void 0 === s ? void 0 : s.children
        )
        .filter((t) => t !== h);
      this.config.toggle &&
        g.length > 0 &&
        ...
        this.emit("show.metisMenu", { showElement: i }),
    ...
    hide(t) {
      ...
      this.emit("hide.metisMenu", { hideElement: r });
      ...
      const a = () => {
        r.classList.remove(l),
          ...
          this.setTransitioning(!1),
          this.emit("hidden.metisMenu", { hiddenElement: r });
      };
